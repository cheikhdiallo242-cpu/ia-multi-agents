...
def lancer_debat_ia(sujet_initial):
    ...
    reponse_1 = client.models.generate_content(model='gemini-2.5-flash', contents=prompt_agent_1)
    ...
    reponse_2 = client.models.generate_content(model='gemini-2.5-flash', contents=prompt_agent_2)
    ...
    reponse_3 = client.models.generate_content(model='gemini-2.5-flash', contents=prompt_agent_3)
    print(f"\n[Version Finale par le Synthétiseur] :\n{reponse_3.text}\n" + "="*40)

if __name__ == "__main__":
    lancer_debat_ia("Créer une routine matinale pour booster sa productivité.")
